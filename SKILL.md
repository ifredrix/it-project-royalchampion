---
name: it-project-codename-royalchampion
description: Reference directory mapping 17 IT roles across 6 categories (Software Architect, Lead Developer, Desktop Application Developer, System & Integration Developer, PM, Scrum Master, UX/UI Designer, UX Researcher, QA Manual/Automation, Security Tester, DevOps, SysAdmin, Release Manager, Product Manager, Product Owner) and their specific responsibilities for native desktop application projects (Windows/macOS/Linux using WPF, Qt, Swift, Win32, JavaFX). Use this whenever the user is structuring a desktop-app team, writing job descriptions or role responsibilities, building a RACI matrix, identifying skill gaps, assigning tasks by role, or asking who should own a native-desktop task such as installers, code signing, auto-updaters, OS-level integration, or offline-first architecture. Not intended for web/SaaS, mobile, Electron/Tauri hybrid, game, AI/ML, or blockchain projects.
license: MIT
---
...
- Integrating native UI with application logic and OS-level APIs
